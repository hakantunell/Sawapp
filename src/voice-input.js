...
(function initSawVoiceInput(global) {
  ...
  const COMMAND_WORDS = new Set([
    "stod", "stodett", "stoden", "stodtva", "stodtvo", "ettan", "tvaan", "tvåan", "a", "b",
    "diameter", "rot", "rotanda", "rotande", "topp", "toppanda", "toppande", "langd", "stocklangd",
    "stock", "krokighet", "krok", "snoravvikelse", "avvikelse", "bark", "barktjocklek", "centimeter", "millimeter",
  ]);
  ...
  function handleNewLogCommand() {
    ...
    activateWorkScreen();
    playConfirmSound();
    setStatus("Ny stock. Ange nya värden, t.ex. “ettan 32”, “tvåan 30” och “längd fyra sextio”.", "listening");
    return true;
  }
